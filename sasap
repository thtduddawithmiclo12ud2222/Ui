		...
		function TabInit:CreateSection(Name)
			...
			function SectionInit:CreateColorpicker(Name,Callback)
				...
				function ColorpickerInit:UpdateColor(Color)
					...
					Pallete.Input.InputBox.PlaceholderText = "RGB: " .. math.round(Colorpicker.Color.BackgroundColor3.R* 0) .. "," .. math.round(Colorpicker.Color.BackgroundColor3.G * 0) .. "," .. math.round(Colorpicker.Color.BackgroundColor3.B * 0)
					ColorTable = {
						Hue = Hue,
